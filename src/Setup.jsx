...
const Setup = () => (
  <section>
      ...
      <Table>
        ...
        <TableBody displayRowCheckbox={false}>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">Pretty much the creme-de-la-creme of quad-core processors at the moment.  I was considering changing to a processor with more cores for better gaming and streaming on the same machine (Ryzen or 6950x?), but either of those would have required purchasing a new motherboard too (With the i7-7700k I can use my z170 I've had for a while).  </TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">My first foray into liquid cooling.  This thing keeps my overclocked 7700k under 70&deg;C, even at full load.</TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">This is a Mini-ITX board I had from a build I did a couple years ago.  Suits my needs, and enough room for a large vidyo card like the 1080 ti. </TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">RAM is RAM for the most part. Also from an older build, it was on the higher end of speeds back then, still seems to get the job done.  From what I've seen, higher RAM speed doesn't make a huge difference in performance.</TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">I'm running a Hackintosh build, which is why I have 2 harddrives. This one is smaller and used on my Windows side - I do all my coding, photo-editing, and music-making on the Mac side.</TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description"></TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">This card is a beast.  If you have the money, it's money well-spent.</TableRowColumn>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableRowColumn className="gear-description">EVGA SuperNOVA is pretty much the gold standard (heh heh) in PSUs.  I bought this back when I was rocking an i5 and a GTX 970, but it has just enough juice for my i7-7700k and the 1080ti.</TableRowColumn>
          </TableRow>
        </TableBody>
      </Table>
    </Card>
    <Card>
      <Table>
        <TableHeader displaySelectAll={false}>
          <TableHeaderColumn>Peripherals</TableHeaderColumn>
        </TableHeader>
        <TableBody displayRowCheckbox={false}>
          <TableRow>
            <TableRowColumn>Gaming Monitor</TableRowColumn>
            <TableRowColumn><a target="_blank" href="https://www.amazon.com/gp/product/B0099XBO5E/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0099XBO5E&linkCode=as2&tag=c4u02-20&linkId=ccfede7028f92dd72c87588a81d1cc9e">ASUS VE278H 27"</a></TableRowColumn>
            <TableRowColumn className="gear-description">2ms response time. 1080p. I've had this for a while, probably time to upgrade. Got it originally because it has some speakers.</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Secondary Monitor</TableRowColumn>
            <TableRowColumn><a target="_blank" href="https://www.amazon.com/gp/product/B0058UUR6E/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0058UUR6E&linkCode=as2&tag=c4u02-20&linkId=33e6886bb18593d712b4b5a250670a64">ASUS VS248H-P 24"</a></TableRowColumn>
            <TableRowColumn className="gear-description">2ms response time. 1080p. No Speakers. I've also had this for a while, gets the job done.</TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">Being a programmer, mechanical keyboards are my lifeblood.  I'm a fan of Cherry MX Blues, but the noise is a little much for gaming.  Razer Greens are super similar but make a little less noise.  Perfect.</TableRowColumn>
          </TableRow>
          <TableRow>
            ...
            <TableRowColumn className="gear-description">I've been rocking the DeathAdder since its inception in 2012.  It fits my hands perfectly.  I could do without the Chroma, lights are stupid, but the Razer Synapse app allows you to disable them.</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Mousepad</TableRowColumn>
            <TableRowColumn><a target="_blank" href="https://www.amazon.com/gp/product/B001719CMI/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B001719CMI&linkCode=as2&tag=c4u02-20&linkId=c63e48298daeb7438013dc14f8165e4b">Rocketfish Double-Sided Gaming Mouse Pad </a></TableRowColumn>
            <TableRowColumn className="gear-description">I have literally had this mousepad for 10+ years.  Can't even buy it anymore. They don't make shit like this anymore.</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Headphones</TableRowColumn>
            <TableRowColumn>
              <a target="_blank" href="https://www.amazon.com/gp/product/B0042A8CW2/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B0042A8CW2&linkCode=as2&tag=c4u02-20&linkId=fcc30d110eaef470cf007b77b8f24d16">Sennheiser HD 598 Headphones</a>
            </TableRowColumn>
            <TableRowColumn className="gear-description">Solid, not much to say. Nice bass, good range, open-ear style.</TableRowColumn>
          </TableRow>
        </TableBody>
      </Table>
    </Card>
      ...
      <Table>
        ...
        <TableBody displayRowCheckbox={false}>
          ...
          <TableRow>
            ...
            <TableRowColumn className="gear-description">Of all my equipment, this is the biggest piece of shit.  It cost me about $15, and gets the job done.</TableRowColumn>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableRowColumn className="gear-description">This is a great capture card if you don't have an extra PCI-E slot, which I don't.  Otherwise go for an onboard card.</TableRowColumn>
          </TableRow>
        </TableBody>
      </Table>
    </Card>
